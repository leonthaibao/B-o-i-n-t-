...
router.post('/categories/update',(req,res)=>{
    ...
    categoryModel.update(entity).then(n=>{
        res.redirect('/admin',{layout: false,});
...
router.post('/posts/delete',(req,res)=>{
    ...
    postModel.delete(req.body.inputid).then(n=>{
        res.redirect('/admin/posts',{layout: false,});
    }).catch(err=>{
        console.log(err);
    });
})
...
router.post('/posts/rollback',(req,res)=>{
    ...
    postModel.update(entity).then((id)=>{
        console.log(id);
        res.redirect('/admin/posts/refuselist',{layout: false,});
    }).catch(err=>{
        console.log(err);
    });
})
...
router.post('/tags/add',(req,res)=>{
    ...
    tagModel.add(entity).then((id)=>{
        console.log(id);
        res.redirect('/admin/tags',{layout:false,});
    }).catch(err=>{
        console.log(err);
    });
})
